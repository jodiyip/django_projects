...
for row in rows:
    ...
    site = Site(name=row[0], description=row[1], justification=row[2], category=c, iso=i, region=r, states=s, year=year, longitude=longitude, latitude=latitude, area_hectares=area)
    site.save()