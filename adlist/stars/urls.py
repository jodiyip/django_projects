...
urlpatterns = [
    ...
    path('star/<int:pk>/favorite',
        views.AddFavoriteView.as_view(), name='star_favorite'),
    path('star/<int:pk>/unfavorite',
        views.DeleteFavoriteView.as_view(), name='star_unfavorite'),
]